...
截至 2026-07-31，BTC 距離 2025-10-06 的高點 126,197 已經 **−50.2%**，今年至今 **−28.2%**。
這正是網格設計上最有利的環境，實測結果也支持：

| 2026 至今 | 報酬 | 最大回撤 | 期末持幣 |
|---|---:|---:|---:|
| **網格（本 Skill）** | **−11.22%** | **14.36%** | **0.1410 BTC** |
| DCA 週定投 | −12.42% | 21.74% | 0.1391 BTC |
| 馬丁（8 層安全單） | −25.43% | 31.40% | 0.1185 BTC |
| 買入持有 | −28.23% | 40.43% | 0.1140 BTC |
...
它們付的是 **taker 費 + 不利滑點**；網格多數成交是 maker——這是掛單的真實結構性優勢，不是我們偏袒自己。
馬丁參數用的是業界通用預設（2% 底倉、8 層安全單、每跌 2.5% 加碼 1.5 倍、均價 +1.5% 止盈），沒有調校。
